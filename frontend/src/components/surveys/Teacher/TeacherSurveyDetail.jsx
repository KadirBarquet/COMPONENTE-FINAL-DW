...
export default function TeacherSurveyDetail() {
    ...
    const getLikelihoodColor = (likelihood) => {
        switch (likelihood) {
            case 'Muy probable': return 'bg-green-100 text-green-800 border-green-200';
            case 'Probable': return 'bg-blue-100 text-blue-800 border-blue-200';
            case 'Imposible': return 'bg-yellow-100 text-yellow-800 border-yellow-200';
            case 'Muy improbable': return 'bg-red-100 text-red-800 border-red-200';
